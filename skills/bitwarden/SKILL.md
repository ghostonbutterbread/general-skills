...
5. Store durable target credentials in Bitwarden. Local notes may contain only account alias, username/email, target, purpose, destructible status, cleanup note, and Bitwarden item name/id.
