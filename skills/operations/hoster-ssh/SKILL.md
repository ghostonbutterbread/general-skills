...
```bash
HELPER=/home/ryushe/.openclaw/workspace/skills/operations/hoster-ssh/scripts/hoster_user_unit.py
# In Hermes-only environments use ~/.hermes/synced-skills/operations/hoster-ssh/scripts/hoster_user_unit.py.
