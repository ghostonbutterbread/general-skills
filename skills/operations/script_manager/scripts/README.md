...
- Example:
  ```bash
  python3 skills/operations/script_manager/scripts/chunk_list.py extract urls.txt --output chunks.txt
  python3 skills/operations/script_manager/scripts/chunk_list.py diff chunks.txt known_chunks.txt --new-output new_chunks.txt
  ```
