...
- Example:
  ```bash
  python3 skills/operations/daddy/scripts/daddy_benchmark.py
  ```
- Tests: run the example command and verify all four scenarios print.
- Owner: general-skills/operations/daddy
...
- Example:
  ```bash
  python3 skills/operations/daddy/scripts/daddy_resolve.py --provider chatgpt --current terra --movement up
  python3 skills/operations/daddy/scripts/daddy_resolve.py --provider chatgpt --current gpt-5.7 --movement down
  ```
